...
import CameraScreenEdge from './src/screens/CameraScreenEdge';
      ...
      <Stack.Navigator>
        {user ? (
          <>
            ...
            <Stack.Screen name="Camera" component={CameraScreen} options={{ headerTitle: 'Scan Meal (Server)', headerTitleStyle: { fontWeight: '700', fontSize: 18, color: '#333'}, headerTitleAlign: 'center' }} />
            <Stack.Screen name="CameraEdge" component={CameraScreenEdge} options={{ headerTitle: 'Scan Meal (Edge)', headerTitleStyle: { fontWeight: '700', fontSize: 18, color: '#333'}, headerTitleAlign: 'center' }} />
